...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <referenced-snippets/>
    <typed-variables>
      <typed-variable name="forRobot" type-name="forRobot"/>
      <typed-variable name="output" type-name="output"/>
    </typed-variables>
    <parameters>
      <parameter name="forRobot" type-name="forRobot"/>
    </parameters>
    <return-variables>
  ...
  <property name="variables" class="Variables">
    <object class="Variable" serializationversion="1">
      <property name="name" class="String">forRobot</property>
      <property name="parameter" class="Boolean" id="0">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">forRobot</property>
        </property>
      </property>
    </object>
    <object class="Variable" serializationversion="1">
      ...
      <object class="Transition" serializationversion="3" id="4">
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="Expression" serializationversion="1">
            <property name="text" class="String">"Contestant "+forRobot.name+" has ticket number "+forRobot.index</property>
          </property>
